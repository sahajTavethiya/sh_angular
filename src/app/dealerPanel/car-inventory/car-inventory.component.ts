...
import { ConfirmationDialogComponentComponent } from '../../components/ConfirmationDialogComponent/confirmation-dialog-component/confirmation-dialog-component.component';
...
@Component({
  ...
  styleUrl: './car-inventory.component.css'
})
export class CarInventoryComponent implements OnInit {

  constructor(public service: LoginService, public router: Router, private route: ActivatedRoute, public dialog: MatDialog) { }
