...
export class ViewDocumentComponent implements OnInit {
 ...
 // @Input() requestId: any;
  ...
  constructor(readonly formBuilder: RxFormBuilder,
    readonly service: MaterialIssueService,
  ...
  ngOnInit(): void {
    ...
    this.service.downloadMaterialIssueFile(this.data.image).subscribe((data1:any) => {
  ...
  viewImageAll(){
    ...
    this.service.downloadMaterialIssueFile(this.data.image).subscribe((data:any) => {
