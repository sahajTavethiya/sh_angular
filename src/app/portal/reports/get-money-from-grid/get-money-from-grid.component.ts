...
@Component({
  selector: 'app-get-money-from-grid',
  templateUrl: './get-money-from-grid.component.html',
  styleUrls: ['./get-money-from-grid.component.scss']
})
export class GetMoneyFromGridComponent implements OnInit {
  constructor(
  ...
  cols = [
    { header: 'Id', field: 'Id' },
    { header: 'Get Money From', field: 'getMoneyFrom' },
  ...
  search() {
    ...
    if (this.searchForm.valid) {
      ...
      this.service
        .GetListOfRemainingPaymentToReceive(this.searchData)
