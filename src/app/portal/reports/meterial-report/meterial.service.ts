...
export class MeterialService extends BaseService {
  ...
  getAllMaterialReceiptForExcelExport(searchCriteria: any) {//SearchSRCriteria
    
    return this.api.post<Array<any>>(this.apiProxy.ServiceRequest.getAllMaterialReceiptForExcelExport(), searchCriteria);
  }
